...
extern const uint32_t unicodeBlocksCount;
extern const uint32_t unicodeBlocks[];
extern const uint32_t unicodeBlocksIgnoreCount;
extern const uint32_t unicodeBlocksIgnore[];
